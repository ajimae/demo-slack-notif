...
function initializeClientInstance() {
  ...
  const opt = {
    ...
    credentials: {
      ...
      // clientId: 'R6w7DO6fd3WIOqcNQVJgJNHm',
      // clientSecret: 'Rvjlp5Jm1UxWySit-7TfR_A4PZUMiWS6'
    },
    fetch,
...
main().then(result => {
  fs.writeFile('./.data/result1.json', JSON.stringify(result), { encoding: 'utf-8' }, function (error) {
